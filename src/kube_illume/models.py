"""
Core domain models for kube-illume.
...
class SavedStrings:
    """
    Global saved string lists, persisted to ~/.config/kube-illume/strings.yaml.
...
class SessionConfig:
    ...
    Persisted per-namespace to ~/.config/kube-illume/namespaces/<ns>.yaml.
    """
    namespace: str
